...
# Philipines
  PHL <- function(x) {
  if (grepl("Philippine| Philippine  Ids| Philippine  Islands| Philippine  Isls| Philippine's|Philippines| Philippines  Isl| Philippines  Islands|Phill| Phillipine  Islands| Phillipines| Philip| Batan  Island| Batanta  Islands| Bongao  Islands| Filipines", x, ignore.case = TRUE)) {
    return("Philippines")
  } else {
    return(x)
  }
...
# Burma/Myanmar
  MMR <- function(x) {
  if (grepl(" Burma| Burma;  India| Burma;  Malaysia;  Thailand| Myanmar", x, ignore.case = TRUE)) {
    return("Myanmar")
  } else {
    return(x)
  }
...
# New Zeland
  NZL <- function(x) {
  if (grepl(" Chatham  Islands;  New  Zealand| New  Zealand| The  Snares;  New  Zealand| Chatham  Islands| Tokelau| Antipodes  Island| Antipodes  Islands| Antipodes  Islands. [ S.e.  Of  New  Zealand]| Antipodes  Islands;  New  Zealand| Auckland  Island|Auckland  Island| Campbell  Island| Kermadec  Islands", x, ignore.case = TRUE)) {
    return("New Zealand")
  } else {
    return(x)
  }
...
# Australia
  AUS <- function(x) {
  if (grepl(" Cocos ( Keeling)  Islands| Christmas  Island| Australia| S.w.  Australia| Gold  Coast| Gold  Coast  Hinter| Gold  Coast  Hinterland| Hinterland  Gold  Coast| Hinterland  Of  Gold  Coast| Heard  Island  And  Mcdonald  Islands", x, ignore.case = TRUE)) {
    return("Australia")
  } else {
    return(x)
  }
...
# China
    CHN <- function(x) {
  if (grepl(" C.  China| Centr.  China| China| E  China| E.  China| East  China| N.  China| N.e.  China| North  China| Off  S.  China| S.  China| S.  Of  China| S..  China| S.e  China| S.e.  China| S.w.  China| W  China| W.  China| Western  China| Hainan| Hainan  Islands", x, ignore.case = TRUE)) {
    return("China")
  } else {
    return(x)
  }
...
# Greece
    GRC <- function(x) {
  if (grepl(" Greece| Greeks| Cerigo  Islands| Crete| Crete  Islands| Isl.  Of  Skyros", x, ignore.case = TRUE)) {
    return("Greece")
  } else {
    return(x)
  }
...
# Chile
    CHL <- function(x) {
  if (grepl(" Easter  Island| Chile| Juan  Fernandez  Islands", x, ignore.case = TRUE)) {
    return("Chili")
  } else {
    return(x)
  }
...
#Ecuador
    ECU <- function(x) {
  if (grepl(" Ecuador| Galapagos  Archipelago;  Ecuador| Galapagos  Islands", x, ignore.case = TRUE)) {
    return("Ecuador")
  } else {
    return(x)
  }
...
# Senegal
    SEN <- function(x) {
  if (grepl(" Senegal| Senegal  Colony| W.  Senegal| W.  Senegal  Colony| W'ern  Senegal  Colony| Western  Senegal| Western  Senegal  Colony", x, ignore.case = TRUE)) {
    return("Senegal")
  } else {
    return(x)
  }
...
# Malaysia
    MYS <- function(x) {
  if (grepl(" Gt.  Redang  Islands| Malaysia", x, ignore.case = TRUE)) {
    return("Malaysia")
  } else {
    return(x)
  }
...
# Netherlands
    NLD <- function(x) {
  if (grepl(" Netherland| Netherlands| The  Netherlands| Holland", x, ignore.case = TRUE)) {
    return("Netherlands")
  } else {
    return(x)
  }
...
# Sudan
    SDN <- function(x) {
  if (grepl(" Sudan| Port  Sudan| Khartum", x, ignore.case = TRUE)) {
    return("Sudan")
  } else {
    return(x)
  }
